# PF-V2.5 Shape Fail-Loud

- db: `tpch1`
- mode: `strict_mode=on`, `query_driven_mode=off`, `policy_first_v2=on`, `policy_first_v2_force=on`

## Cases
- F_XNE: PASS :: cross-table != comparator unsupported in PF-V2.5 :: error=`ERROR:  policy: PF-V2 path unsupported term shape on target=orders HINT:  disable custom_filter.policy_first_v2_force or disable custom_filter.policy_first_v2`
